      ...
      {!channelId ? (
        <div className={styles.board}>
          ...
          <div className={styles.boxWrapper}>
            <Link
              to="?channelId=c21yiUdn1sl4S57BYbr8&title=Airbnb Engineering &amp; Data Science&description=Creative engineers and data scientists building a world where you can belong anywhere. http://airbnb.io"
            ...
            >
              ...
              <div className={styles.boxDescription}>
                Engineering and technology articles for developers, written and
                curated by Googlers.
              </div>
            </Link>
            <Link
              to="?channelId=K7eGFfzcCrXErhBPsKM0&title=JavaScript In Plain English - Medium&description=New JavaScript + Web Development articles every day"
              className={styles.box}
            >
              <div className={styles.boxImg}>
                <img src={plain} alt="" />
            ...
            <Link
              to="?channelId=KcRLeBkx37MWou5HbGKe&title=LogRocket Blog&description=For Frontend Developers and Web App Engineers"
              className={styles.box}
            >
              <div className={styles.boxImg}>
          ...
          <div className={styles.boxWrapper}>
            ...
            <Link
              to="?channelId=I14qjeQLYk4hfxBTW1lF&title=Bits and Pieces&description=The best of web development articles, tutorials, and news."
              className={styles.box}
            >
              <div className={styles.boxImg}>
                <img src={medium} alt="" />
            ...
            <Link
              to="?channelId=5L6M2nLNRkXNjjFCu1gB&title=Daily JS&description=JavaScript news and opinion."
              className={styles.box}
            >
              <div className={styles.boxImg}>
                <img src={dailyJS} alt="" />
